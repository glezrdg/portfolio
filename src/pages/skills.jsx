...
const Skills = () => {
  return (
    <section
      id="skills"
      className="relative h-[100vh] w-full flex flex-col items-center  "
    >
      <div className="absolute top-0 bottom-0 -right-[16vw] -z-10 -left-[16vw] bg-zinc-100 "></div>

      <div className="text-center h-1/3 flex flex-col items-center justify-center">
        <span className="bg-yellow-400  p-1">What I Do?</span>
        <h1 className="text-5xl font-semibold mt-5">
          How I can help your next project
        </h1>
      </div>
      <div className="h-2/3  grid  grid-cols-3 grid-rows-2 gap-9">
