      ...
      <div className=" flex flex-col justify-evenly items-center ">
        <div className="text-lg  text-justify font-semibold text-balance grid grid-cols-2 gap-10 ">
          ...
          <p>
            ...
            González continuó expandiendo su visión a través de "Orbitarq" y
            luego como contratista independiente, colaborando en proyectos de
            alto perfil como "Las Terrazas" en Piantini y villas de lujo en Cap
            Cana Juanillo Bay. Su obra en la República Dominicana es un
            testimonio de su capacidad para liderar y ejecutar proyectos
            complejos, desde torres empresariales en la emblemática esquina
            Churchill hasta la creación de espacios residenciales que combinan
